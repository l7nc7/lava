...
sys.stdout.write("\x1b]2;ByPASS |HUB| D O W N E D\x07")
def modifications():
...
method = """\033[91m
╔══════════════════════════════════════════════════════╗
║                     \033[00mByPASS METHODS               
║
║ \033[00mUDP  <HOST> <PORT> <TIMEOUT> <SIZE>
║ \033[00mICMP <HOST> <PORT> <TIMEOUT> <SIZE>
║ \033[00mXSYN <HOST> <PORT> <TIMEOUT> <SIZE>
║ \033[00mOPENVPN <HOST> <PORT> <TIMEOUT> <SIZE>
║ \033[00mHTTP <HOST> <PORT> <TIMEOUT> <SIZE>
╚══════════════════════════════════════════════════════╝\033[00m
"""

info = """
[\033[91mSIN\033[00m] \033[91mCortex, Made By Envy, Updated Design By ISOLaTiON Xy.
Re Coded from sinfull,
...
║ \033[00mExit                          \033[91m|\033[00m EXIT CORTEX \033[91m         ║
...
║ \033[00mInfo                          \033[91m|\033[00m DISPLAY CORTEXS INFO\033[91m ║
╚══════════════════════════════════════════════════════╝\033[00m
"""
...
║ \033[00mStats                         \033[91m|\033[00m DISPLAY CORTEX STATS\033[91m║
╚══════════════════════════════════════════════════════╝\033[00m
"""
...
def main():
	...
	while True:
		sys.stdout.write("\x1b]2;C O R T E X\x07")
		sin = input("\033[1;00m[\033[91mCORTEX\033[1;00m]-\033[91m家\033[00m ").lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (altbanner)
			...
			sfound = 0
			sys.stdout.write("\x1b]2;C O R T E X |{}| F O U N D\x07".format (sfound))
			try:
				host = sin.split(" ")[1]
			...
			try:
				...
				while True:
					try:
						...
						sys.stdout.write("\x1b]2;C O R T E X |{}ms| D E M O N S\x07".format (stop))
						print ("Sinfull: {}:{} | Time: {}ms [\033[91mUP\033[00m]".format(ip, port, stop))
						sock.close()
						time.sleep(1)
					except socket.error:
						sys.stdout.write("\x1b]2;C O R T E X |TIME OUT| D E M O N S\x07")
